...
const architectureRestaurantPlainRaw =
  "Ресторанная часть спроектирована как упрощённая операционная панель для малого бизнеса";
...
export const foodTechProjectImages = {
  ...
  architectureClient: {
    ...
    alt: "Схема клиентского пользовательского потока",
  },
  architectureRestaurant: {
    src: "/img/04_04_02_02.svg",
    alt: "Схема ресторанной операционной панели",
  },
  interfaceSystem: {
