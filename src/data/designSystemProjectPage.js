...
const applicationPlainRaw =
  "Дизайн-система применялась при проектировании пользовательских сценариев с учётом ролей и логики продукта. Компоненты объединяются в паттерны и используются во всей системе — от управления задачами до настройки конфигурации.";
